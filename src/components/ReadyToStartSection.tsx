      ...
      <Container maxWidth="xl" sx={{ px: { xs: 4, md: '10%' } }}>
        ...
        >
          ...
          <Box sx={{ display: 'flex', justifyContent: { xs: 'center', md: 'flex-start' } }}>
            <Image src={appImg} alt="App Chilli Drinks" style={{ width: '100%', height: 'auto', maxWidth: 380 }} width={380} height={380} />
          </Box>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', color: '#FFFFFF' }}>
            ...
            <Button
              ...
              target="_blank"
              sx={{ bgcolor: '#0080FF', color: '#FFFFFF', borderRadius: '1000px', py: 2, px: 6, fontSize: '1.25rem', fontWeight: 700, whiteSpace: 'nowrap', width: 'fit-content', maxWidth: '521px', boxShadow: 'none', border: 'none', '&:hover': { bgcolor: '#0066cc', boxShadow: 'none' } }}
            >
